...
function Search(props) {
  return (
    ...
    <form className={style.searchForm}>
      <input type="text" className={style.searchBar} onChange={e => props.setQuery(e.target.value)} value={props.query} onKeyPress={props.search} placeholder="Поиск по городу или стране"></input>
      <button onClick={props.search} className={style.searchBtn}><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1.5em"
